...
IF DB_NAME() <> N'db-fieldvisit-uat'
    THROW 54300, N'Permission grant refused: target is not db-fieldvisit-uat.', 1;
...
IF @PrincipalId IS NULL
   ...
   (
    ...
    THROW 54301, N'Permission grant refused: expected EXTERNAL_USER is missing.', 1;

IF ISNULL(IS_ROLEMEMBER(N'db_datareader', N'gh-fieldvisit-uat-migrate'), 0) <> 1
    THROW 54302, N'Permission grant refused: retained db_datareader baseline is missing.', 1;
...
IF ISNULL(IS_ROLEMEMBER(N'db_ddladmin', N'gh-fieldvisit-uat-migrate'), 0) = 1
   ...
   OR ISNULL(IS_ROLEMEMBER(N'db_datawriter', N'gh-fieldvisit-uat-migrate'), 0) = 1
    THROW 54303, N'Permission grant refused: forbidden elevated or broad role exists.', 1;
...
(
    ...
    THROW 54304, N'Permission grant refused: unexpected role membership exists.', 1;
...
(
    ...
    THROW 54305, N'Permission grant refused: explicit baseline is not approved CONNECT only.', 1;
...
IF OBJECT_ID(N'dbo.SchemaVersions', N'U') IS NULL
   ...
   OR OBJECT_ID(N'dbo.VisitTripSnapshotStops', N'U') IS NULL
    THROW 54306, N'Permission grant refused: required 1.8.0-006 predecessor objects are missing.', 1;
...
(
    ...
    THROW 54307, N'Permission grant refused: exact predecessor 1.8.0-005 is missing.', 1;
...
(
    ...
    THROW 54308,
        N'Permission grant refused: latest SchemaVersion is not exact predecessor 1.8.0-005.',
        1;
...
(
    ...
    THROW 54309, N'Permission grant refused: target 1.8.0-006 already exists.', 1;
...
IF OBJECT_ID(N'dbo.NotificationEnvironmentPolicies', N'U') IS NOT NULL
   ...
   OR COL_LENGTH(N'dbo.Employments', N'EmailNotificationEnabled') IS NOT NULL
    THROW 54310, N'Permission grant refused: one or more of 8 Stage 006 partial-state markers exist.', 1;
...
IF @CanUpdateEmployments <> 0
   ...
   OR @CanUpdateDeploymentAssignments <> 0
    THROW 54311, N'Permission grant refused: pre-stage UPDATE capability residue exists.', 1;
...
SELECT N'GRANT_PREPARED_FOR_1800_006' AS PermissionState,
