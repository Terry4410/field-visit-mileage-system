...
public sealed class AppDbContext(DbContextOptions<AppDbContext> options) : DbContext(options), IUnitOfWork
{
    ...
    protected override void OnModelCreating(ModelBuilder b)
    {
        ...
        // v1.8.0-007 mileage / Google governance runtime mapping. The SQL
        // migration remains the schema authority; these mappings deliberately
        // expose only the frozen audit and decision-evidence surfaces.
