...
export interface Trip{visitTripId:number;tripNo:string;userId:number;visitorName:string;teamId?:number;teamName?:string;visitDate:string;startTime?:string;endTime?:string;hasTimeOverlapWarning:boolean;timeOverlapConfirmed:boolean;status:string;statusName:string;purpose?:string;notes?:string;returnReason?:string;claimedDistanceKm?:number;systemDistanceKm?:number;approvedDistanceKm?:number;ratePerKmSnapshot?:number;approvedAmount?:number;employmentId?:number;startDeploymentSiteId?:number;startDeploymentSiteCode?:string;startDeploymentSiteName?:string;startDeploymentAddress?:string;endDeploymentSiteId?:number;endDeploymentSiteCode?:string;endDeploymentSiteName?:string;endDeploymentAddress?:string;stops:TripStopInput[];rowVersion:string}
export interface V180RouteSuggestion{routeCalculationAttemptId:number;correlationId:string;status:string;suggestedDistanceKm?:number;durationSeconds?:number;encodedPolyline?:string;errorCode?:string;errorMessage?:string}
export interface V180TripContextTeam{teamId:number;code:string;name:string;isPrimary:boolean}
export interface V180TripContextDeploymentSite{deploymentSiteId:number;centerId:number;centerCode:string;centerName:string;siteCode:string;siteName:string;locationId:number;locationCode?:string;locationName:string;address?:string;isPrimary:boolean}
export interface V180TripContext{employmentId:number;visitDate:string;eligibleForTrip:boolean;validationCode:string;validationMessage:string;teams:V180TripContextTeam[];selectedTeamId?:number;eligibleDeploymentSites:V180TripContextDeploymentSite[];primaryDeploymentSiteId?:number;defaultStartDeploymentSiteId?:number;defaultEndDeploymentSiteId?:number}
...
export interface TripQueryRow{visitTripId:number;tripNo:string;visitDate:string;startTime?:string;endTime?:string;visitorId:number;employeeNo:string;visitorName:string;teamId?:number;teamName?:string;route:string;projectNames:string;visitTypeNames:string;claimedDistanceKm?:number;systemDistanceKm?:number;approvedDistanceKm?:number;ratePerKmSnapshot?:number;subsidyAmount?:number;mileageState:string;status:string;statusName:string;snapshotVersion:number;isSnapshot:boolean;notes?:string;returnReason?:string;correctionStatus?:string;employmentId?:number;startDeploymentSiteId?:number;startDeploymentSiteCode?:string;startDeploymentSiteName?:string;startDeploymentAddress?:string;endDeploymentSiteId?:number;endDeploymentSiteCode?:string;endDeploymentSiteName?:string;endDeploymentAddress?:string;stops:QueryStop[]}
