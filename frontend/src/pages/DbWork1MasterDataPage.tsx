    ...
    <div className="grid cols-2">
      <div className="card">
        ...
        <div className="grid cols-2">
          ...
          <div className="field"><label htmlFor="dbw1-project-name">專案名稱</label><input id="dbw1-project-name" value={name} onChange={e => setName(e.target.value)} /></div>
...
function VisitTypesPanel() {
  ...
  return <div className="card">
    ...
    {msg && <div className="note">{msg}</div>}
    <div className="grid cols-2"><div className="field"><label>代碼</label><input value={code} onChange={e => setCode(e.target.value)} /></div><div className="field"><label>名稱</label><input value={name} onChange={e => setName(e.target.value)} /></div><div className="field span-2"><label htmlFor="dbw1-visit-type-description">說明</label><input id="dbw1-visit-type-description" value={desc} onChange={e => setDesc(e.target.value)} /></div></div>
